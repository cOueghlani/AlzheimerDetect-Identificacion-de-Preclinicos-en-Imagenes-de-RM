...
# Remove the rows = '9999' of the column D. Now --> [360 rows x 208 columns]
bd_sinFilasNa = bd[bd['CSF_AB42_Cutoff_LUD/Sant_pau'].isin([0, 1])]
...
y = bd_sinFilasNa.iloc[:, 3]    # Sólo la columna C, sin las filas NA 
